# -*- coding: utf-8 -*-
"""
Created on Fri Jun 13 17:28:19 2025
...
output_png_path = r"C:\Users\Moi\Desktop\tfg\videoimatgesvilanova\posidoniavilanova3juliol20234bandas\codis\outputmesgran.png"
...
# Assegurar que el shapefile està en EPSG:4326 
gdf = gdf.to_crs("EPSG:4326")

# Aplicar una dilatació més gran al polígon
# Convertir la resolució de píxels a coordenades (graus)
dilatation_pixels = 100
dilatation_degrees_x = dilatation_pixels * res_x  # Correspondència en graus per píxel
dilatation_degrees_y = dilatation_pixels * res_y

# Dilatar els polígons en la geometria
gdf["geometry"] = gdf["geometry"].apply(lambda geom: geom.buffer(dilatation_degrees_x, resolution=16))
